...
import com.bank.message.dto.AccountsMessageDto;
...
public class MessageFunctions {
    ...
    public Function<AccountsMessageDto, AccountsMessageDto> email() {
        return accountsMessageDto -> {
          log.info("Sending email with the details received: " + accountsMessageDto.toString());
          return accountsMessageDto;
        };
    }
    ...
    public Function<AccountsMessageDto, Long> sms() {
        return accountsMessageDto -> {
            log.info("Sending sms with the details received: " + accountsMessageDto.toString());
